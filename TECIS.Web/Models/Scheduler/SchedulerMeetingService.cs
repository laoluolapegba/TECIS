namespace TECIS.Web.Models.Scheduler
{
    ...
    public class SchedulerMeetingService : ISchedulerEventService<MeetingViewModel>
    {
        ...
        public SchedulerMeetingService(TecIsEntities context)
        {
            db = context;
        }
            ...
            return db.Meetings.ToList().Select(meeting => new MeetingViewModel
                {
                    ...
                    Title = meeting.Title,
                    Start = DateTime.SpecifyKind(meeting.StartDate, DateTimeKind.Utc),
                    End = DateTime.SpecifyKind(meeting.EndDate, DateTimeKind.Utc),
        ...
        public virtual void Update(MeetingViewModel meeting, ModelStateDictionary modelState)
        {
            if (ValidateModel(meeting, modelState))
            {
                ...
                entity.StartDate = meeting.Start;
                entity.EndDate = meeting.End;
